...
kafka-topics --create --bootstrap-server 192.168.43.58:9093 replication-factor 1 --partitions 1 --topic receive_result  --command-config /etc/kafka/secrets/run.properties